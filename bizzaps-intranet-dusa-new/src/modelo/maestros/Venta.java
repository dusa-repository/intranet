...
@Entity
@Table(name = "venta")
@NamedQuery(name = "Venta.findAll", query = "SELECT t FROM Venta t")
public class Venta implements Serializable {
	...
	public Venta(long idVenta, String marca, Double diaria, Double acumulada,
			Double planificada, Timestamp fechaAuditoria, String horaAuditoria,
